...
static void tps65023_init_ldo1_level(void)
{
	int reg;

	reg = i2c_smbus_read_byte_data(tpsclient, TPS65023_LDO_CTRL);
	if (reg >= 0) {
		reg &= 0x70;
		reg |= 0x03;
		i2c_smbus_write_byte_data(tpsclient, TPS65023_LDO_CTRL, reg);
	}
}
