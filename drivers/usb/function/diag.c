/* drivers/usb/function/diag.c  (DIAG Driver)
 *
...
static void diag_bind(void *context)
{
	...
	intf_desc.iInterface =
		usb_msm_get_next_strdesc_id(USB_QXDM_STRING_DESC_WORD);
#endif /* CONFIG_SH_USB_CUST */
...
#ifdef CONFIG_SH_USB_CUST
static int diag_get_interface(int ifc_num, void *_ctxt)
{
	return 0;
}
#endif /* CONFIG_SH_USB_CUST */
...
#ifdef CONFIG_SH_USB_CUST
	usb_func_diag.get_interface = diag_get_interface;
#endif /* CONFIG_SH_USB_CUST */
