/* drivers/usb/function/adb.c  (ADB Driver)
 *
...
static void adb_bind(void *_ctxt)
{
	...
	intf_desc.iInterface =
		usb_msm_get_next_strdesc_id(USB_ADB_STRING_DESC_WORD);
#endif /* CONFIG_SH_USB_CUST */
...
#ifdef CONFIG_SH_USB_CUST
static int adb_get_interface(int ifc_num, void *_ctxt)
{
	return 0;
}
#endif /* CONFIG_SH_USB_CUST */
...
#ifdef CONFIG_SH_USB_CUST
	usb_func_adb.get_interface = adb_get_interface;
#endif /* CONFIG_SH_USB_CUST */
