		    ...
		    unsigned int cmd, unsigned long arg)
{
    ...
    struct msm_device_vol_info dev_vol;
    ...
    case AUDIO_DEVICE_VOLUME:
		rc = copy_from_user(&dev_vol, (void *)arg, sizeof(dev_vol));
		if (!rc)
			rc = q6audio_set_device_volume( dev_vol.device_id, dev_vol.cad_id, dev_vol.level );
		break;
