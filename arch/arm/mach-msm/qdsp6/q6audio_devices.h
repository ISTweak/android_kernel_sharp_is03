...
#define Q6_HW_I2S_RX					6
#define Q6_HW_I2S_RX_SPKR				7
#define Q6_HW_I2S_RX_HEADSET			8
#define Q6_HW_I2S_RX_NO_MIC_HEADSET		9
#define Q6_HW_LINE_IN_MIC				10
#define Q6_HW_I2S_RX_FAREND_TERMINAL	11
#define Q6_HW_LINE_IN_HANDSET			12

#define Q6_HW_COUNT						13
...
#define CAD_HW_DEVICE_ID_I2S_RX_NO_MIC_HEADSET  0x32
#define CAD_HW_DEVICE_ID_LINE_IN_MIC            0x33
#define CAD_HW_DEVICE_ID_I2S_RX_FAREND_TERMINAL 0x34
#define CAD_HW_DEVICE_ID_LINE_IN_HANDSET        0x35
#define CAD_HW_DEVICE_ID_SPKR_BACK_MIC          0x36

#define CAD_HW_DEVICE_ID_MAX_NUM                0x37
...
static struct q6_device_info q6_audio_devices[] = {
	...
	{
		.id	= ADSP_AUDIO_DEVICE_ID_I2S_SPKR,
		.cad_id	= CAD_HW_DEVICE_ID_I2S_RX_SPKR,
		.path	= 0, /* XXX */
		.rate   = 48000,
		.dir	= Q6_RX,
		.codec	= Q6_SDAC_RX,
		.hw	= Q6_HW_I2S_RX_SPKR,
	},
	{
		.id	= ADSP_AUDIO_DEVICE_ID_I2S_SPKR,
		.cad_id	= CAD_HW_DEVICE_ID_I2S_RX_HEADSET,
		.path	= 0, /* XXX */
		.rate   = 48000,
		.dir	= Q6_RX,
		.codec	= Q6_SDAC_RX,
		.hw	= Q6_HW_I2S_RX_HEADSET,
	},
	{
		.id	= ADSP_AUDIO_DEVICE_ID_I2S_SPKR,
		.cad_id	= CAD_HW_DEVICE_ID_I2S_RX_NO_MIC_HEADSET,
		.path	= 0, /* XXX */
		.rate   = 48000,
		.dir	= Q6_RX,
		.codec	= Q6_SDAC_RX,
		.hw	= Q6_HW_I2S_RX_NO_MIC_HEADSET,
	},
	{
		.id	= ADSP_AUDIO_DEVICE_ID_HANDSET_MIC,
		.cad_id	= CAD_HW_DEVICE_ID_LINE_IN_MIC,
		.path	= ADIE_CODEC_LINE_IN_MIC_TX,
		.rate   = 8000,
		.dir	= Q6_TX,
		.codec	= Q6_ICODEC_TX,
		.hw	= Q6_HW_LINE_IN_MIC,
	},
	{
		.id	= ADSP_AUDIO_DEVICE_ID_HANDSET_SPKR,
		.cad_id	= CAD_HW_DEVICE_ID_LINE_IN_HANDSET,
		.path	= ADIE_CODEC_LINE_IN_HANDSET_RX,
		.rate   = 48000,
		.dir	= Q6_RX,
		.codec	= Q6_ICODEC_RX,
		.hw	= Q6_HW_LINE_IN_HANDSET,
	},
	{
		.id	= ADSP_AUDIO_DEVICE_ID_I2S_SPKR,
		.cad_id	= CAD_HW_DEVICE_ID_I2S_RX_FAREND_TERMINAL,
		.path	= 0, /* XXX */
		.rate   = 48000,
		.dir	= Q6_RX,
		.codec	= Q6_SDAC_RX,
		.hw	= Q6_HW_I2S_RX_FAREND_TERMINAL,
	},
	{
		.id	= ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_MIC,
		.cad_id	= CAD_HW_DEVICE_ID_SPKR_BACK_MIC,
		.path	= ADIE_PATH_SPKR_BACK_MIC_TX,
		.rate   = 48000,
		.dir	= Q6_TX,
		.codec	= Q6_ICODEC_TX,
		.hw	= Q6_HW_SPEAKER,
